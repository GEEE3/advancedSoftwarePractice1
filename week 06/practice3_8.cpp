...
void practice3_8(void) {
	...
	fprintf(fp_w, "function value\n");
	fprintf(fp_w, "%.15lf %.15lf %.15lf\n\n", 3 * x[0] - cos(x[1] * x[2]) - 0.5, x[0] * x[0] - 81.0 * (x[1] + 0.1) * (x[1] + 0.1) + sin(x[2]) + 1.06, exp(-x[0] * x[1]) + 20.0 * x[2] + (10.0 * M_PI - 3.0) / 3.0);
	...
	fprintf(fp_w, "%.15lf %.15lf %.15lf\n", x[0], x[1], x[2]);
	fprintf(fp_w, "function value\n");
	fprintf(fp_w, "%.15lf %.15lf %.15lf", 3 * x[0] - cos(x[1] * x[2]) - 0.5, x[0] * x[0] - 81.0 * (x[1] + 0.1) * (x[1] + 0.1) + sin(x[2]) + 1.06, exp(-x[0] * x[1]) + 20.0 * x[2] + (10.0 * M_PI - 3.0) / 3.0);
